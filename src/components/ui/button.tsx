  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary shadow-gold hover:shadow-dark transition-glow text-primary-foreground font-semibold",
        gaming: "bg-gaming-surface border border-gaming-border text-foreground hover:bg-primary hover:text-primary-foreground shadow-dark",
        gold: "bg-nw-gold text-primary-foreground hover:bg-nw-gold-dark shadow-gold transition-glow",
      },
      size: {
